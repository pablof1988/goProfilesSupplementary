...
load("allOncoGeneLists.rda")

geneLists
sapply(geneLists, length)

# Slow process, partitioned in partial tasks:
genListsClustersBP3to5 <- iterEquivClust(geneLists, ontos = "BP", ontoLevels = 3:5,
                                         jobName = "allOnco_gene_lists_equiv_clust_BP_levels3to5",
...
genListsClustersBP6to7 <- iterEquivClust(geneLists, ontos = "BP", ontoLevels = 6:7,
                                         jobName = "allOnco_gene_lists_equiv_clust_BP_levels6to7",
                                         ylab = "Equivalence threshold distance",
                                         orgPackage="org.Hs.eg.db", method = "complete")
...
genListsClustersBP8to9 <- iterEquivClust(geneLists, ontos = "BP", ontoLevels = 8:9,
                                         jobName = "allOnco_gene_lists_equiv_clust_BP_levels8to9",
                                         ylab = "Equivalence threshold distance",
                                         orgPackage="org.Hs.eg.db", method = "complete")
...
genListsClustersBP10 <- iterEquivClust(geneLists, ontos = "BP", ontoLevels = 10,
                                       jobName = "allOnco_gene_lists_equiv_clust_BP_level10",
                                       ylab = "Equivalence threshold distance",
                                       orgPackage="org.Hs.eg.db", method = "complete")
...
genListsClustersCC3to5 <- iterEquivClust(geneLists, ontos = "CC", ontoLevels = 3:5,
                                         jobName = "allOnco_gene_lists_equiv_clust_CC_levels3to5",
                                         ylab = "Equivalence threshold distance",
                                         orgPackage="org.Hs.eg.db", method = "complete")
...
genListsClustersCC6to7 <- iterEquivClust(geneLists, ontos = "CC", ontoLevels = 6:7,
                                         jobName = "allOnco_gene_lists_equiv_clust_CC_levels6to7",
                                         ylab = "Equivalence threshold distance",
                                         orgPackage="org.Hs.eg.db", method = "complete")
...
genListsClustersCC8to9 <- iterEquivClust(geneLists, ontos = "CC", ontoLevels = 8:9,
                                         jobName = "allOnco_gene_lists_equiv_clust_CC_levels8to9",
                                         ylab = "Equivalence threshold distance",
                                         orgPackage="org.Hs.eg.db", method = "complete")
...
genListsClustersCC10 <- iterEquivClust(geneLists, ontos = "CC", ontoLevels = 10,
                                       jobName = "allOnco_gene_lists_equiv_clust_CC_level10",
                                       ylab = "Equivalence threshold distance",
                                       orgPackage="org.Hs.eg.db", method = "complete")
...
genListsClustersMF3to5 <- iterEquivClust(geneLists, ontos = "MF", ontoLevels = 3:5,
                                         jobName = "allOnco_gene_lists_equiv_clust_MF_levels3to5",
                                         ylab = "Equivalence threshold distance",
                                         orgPackage="org.Hs.eg.db", method = "complete")
...
genListsClustersMF6to7 <- iterEquivClust(geneLists, ontos = "MF", ontoLevels = 6:7,
                                         jobName = "allOnco_gene_lists_equiv_clust_MF_levels6to7",
                                         ylab = "Equivalence threshold distance",
                                         orgPackage="org.Hs.eg.db", method = "complete")
...
genListsClustersMF8to9 <- iterEquivClust(geneLists, ontos = "MF", ontoLevels = 8:9,
                                         jobName = "allOnco_gene_lists_equiv_clust_MF_levels8to9",
                                         ylab = "Equivalence threshold distance",
                                         orgPackage="org.Hs.eg.db", method = "complete")
...
genListsClustersMF10 <- iterEquivClust(geneLists, ontos = "MF", ontoLevels = 10,
                                       jobName = "allOnco_gene_lists_equiv_clust_MF_level10",
                                       ylab = "Equivalence threshold distance",
                                       orgPackage="org.Hs.eg.db", method = "complete")
...
genListsClusters$MF <- c(genListsClustersMF3to5$MF, genListsClustersMF6to7$MF, genListsClustersMF8to9$MF, genListsClustersCC10$MF)

class(genListsClusters) <- class(genListsClustersMF8to9)

save(genListsClusters, file = "allOnco_gene_lists_equiv_clust.rda")
equivClust2pdf(genListsClusters, jobName = "allOnco_gene_lists_equiv_clust")
